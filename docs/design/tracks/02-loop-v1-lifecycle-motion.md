...
> **Track, not a single slice.** This file is the design reference. It is executed as 6 one-session tasks: [T-02.1a](../../tasks/008-t-02.1a-animation-clock.md) · [T-02.1b](../../tasks/009-t-02.1b-window-appear.md) · [T-02.2](../../tasks/010-t-02.2-minimize-and-restore-motion.md) · [T-02.3](../../tasks/011-t-02.3-zoom-and-fullscreen-transitions.md) · [T-02.4a](../../tasks/012-t-02.4a-close-ghost.md) · [T-02.4b](../../tasks/013-t-02.4b-close-interruptibility-and-idle-trace.md). Strict order and prerequisites live in [ROADMAP.md](../../ROADMAP.md).
...
| **Legacy detail** | [legacy/35-window-lifecycle-animations.md](../../tasks/legacy/35-window-lifecycle-animations.md) · [legacy/11-mission-control-workspace-ux.md](../../tasks/legacy/11-mission-control-workspace-ux.md) (animation clock) · [legacy/10-dock.md](../../tasks/legacy/10-dock.md) (tile geometry) |
