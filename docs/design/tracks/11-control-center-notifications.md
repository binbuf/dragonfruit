...
> **Track, not a single slice.** This file is the design reference. It is executed as 8 one-session tasks: [T-11.1a](../../tasks/070-t-11.1a-notification-service-core.md) · [T-11.1b](../../tasks/071-t-11.1b-notification-actions-and-dock-badge.md) · [T-11.2a](../../tasks/072-t-11.2a-dnd-focus-policy.md) · [T-11.2b](../../tasks/073-t-11.2b-dnd-reflection-and-dock-failure.md) · [T-11.3a](../../tasks/074-t-11.3a-control-center-panel-and-tiles.md) · [T-11.3b](../../tasks/075-t-11.3b-control-center-focus-dark-a11y.md) · [T-11.4a](../../tasks/076-t-11.4a-osd-overlay.md) · [T-11.4b](../../tasks/077-t-11.4b-osd-a11y-and-captures.md). Strict order and prerequisites live in [ROADMAP.md](../../ROADMAP.md).
...
| **Legacy detail** | [legacy/21-control-center.md](../../tasks/legacy/21-control-center.md) · [legacy/25-notifications-and-osd.md](../../tasks/legacy/25-notifications-and-osd.md) · [04-shell.md](../04-shell.md) · [07-system-integration.md](../07-system-integration.md) |
