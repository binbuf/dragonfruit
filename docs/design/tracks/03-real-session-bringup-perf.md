...
> **Track, not a single slice.** This file is the design reference. It is executed as 5 one-session tasks: [T-03.1a](../../tasks/014-t-03.1a-nested-idle-and-animation-budget.md) · [T-03.1b](../../tasks/015-t-03.1b-latency-and-scanout-instruments.md) · [T-03.2](../../tasks/159-t-03.2-drm-first-bring-up.md) · [T-03.3](../../tasks/160-t-03.3-hardware-input-validation.md) · [T-03.4](../../tasks/161-t-03.4-drm-soak-teardown-runbook.md). Strict order and prerequisites live in [ROADMAP.md](../../ROADMAP.md).
...
| **Legacy detail** | [legacy/02-compositor-core.md](../../tasks/legacy/02-compositor-core.md) · [legacy/03-input-keymaps-shortcuts.md](../../tasks/legacy/03-input-keymaps-shortcuts.md) · [legacy/01-repo-scaffolding-ci-licensing.md](../../tasks/legacy/01-repo-scaffolding-ci-licensing.md) (soak) · [testing-ladder.md](../../testing-ladder.md) |
