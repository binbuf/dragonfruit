...
> **Track, not a single slice.** This file is the design reference. It is executed as 6 one-session tasks: [T-04.1a](../../tasks/016-t-04.1a-shadows.md) · [T-04.1b](../../tasks/017-t-04.1b-rounded-corner-clipping.md) · [T-04.2](../../tasks/018-t-04.2-backdrop-blur-pass.md) · [T-04.3](../../tasks/019-t-04.3-reusable-scene-transform-pass.md) · [T-04.4a](../../tasks/020-t-04.4a-material-degrade-tiers.md) · [T-04.4b](../../tasks/021-t-04.4b-material-schemes-and-sign-off-package.md). Strict order and prerequisites live in [ROADMAP.md](../../ROADMAP.md).
...
| **Legacy detail** | [legacy/33-compositor-effects-materials.md](../../tasks/legacy/33-compositor-effects-materials.md) · [02-compositor.md](../02-compositor.md) · [10-design-system.md](../10-design-system.md) |
