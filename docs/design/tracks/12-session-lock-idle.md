...
| **Legacy detail** | [legacy/24-session-lifecycle.md](../../tasks/legacy/24-session-lifecycle.md) · [legacy/26-lock-screen-idle.md](../../tasks/legacy/26-lock-screen-idle.md) · [11-session-and-dev-workflow.md](../11-session-and-dev-workflow.md) |
