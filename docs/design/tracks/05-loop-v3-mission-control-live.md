...
> **Track, not a single slice.** This file is the design reference. It is executed as 7 one-session tasks: [T-05.1a](../../tasks/022-t-05.1a-live-surface-transform.md) · [T-05.1b](../../tasks/023-t-05.1b-live-video-and-degrade.md) · [T-05.2](../../tasks/024-t-05.2-hit-testing-and-selection-on-live-representations.md) · [T-05.3](../../tasks/025-t-05.3-drag-a-live-representation-between-spaces.md) · [T-05.4](../../tasks/026-t-05.4-image-wallpaper-and-per-space-slide.md) · [T-05.5](../../tasks/027-t-05.5-desktop-reveal.md) · [T-05.6](../../tasks/028-t-05.6-overview-frame-budget-and-capture.md). Strict order and prerequisites live in [ROADMAP.md](../../ROADMAP.md).
...
| **Depends on** | T-04 |
| **Blocks** | T-06 |
| **Legacy detail** | [legacy/11-mission-control-workspace-ux.md](../../tasks/legacy/11-mission-control-workspace-ux.md) · [legacy/05-spaces-model.md](../../tasks/legacy/05-spaces-model.md) · [legacy/14-hot-corners-desktop-background.md](../../tasks/legacy/14-hot-corners-desktop-background.md) · [03-workspaces.md](../03-workspaces.md) |
...
1. **Live-surface transform (legacy B-1/B-3/B-4/B-9)**: scale/clip/blur the
   ...
   ([03-workspaces.md](../03-workspaces.md#window-layout-and-occlusion-t-11-u-5));
   no thumbnails, ever.
