...
> **Track, not a single slice.** This file is the design reference. It is executed as 12 one-session tasks: [T-13.1a](../../tasks/088-t-13.1a-portal-backend-and-session-service.md) · [T-13.1b](../../tasks/089-t-13.1b-settings-and-globalshortcuts-portals.md) · [T-13.2a](../../tasks/090-t-13.2a-filechooser-portal.md) · [T-13.2b](../../tasks/091-t-13.2b-filechooser-picker-ui.md) · [T-13.3a](../../tasks/092-t-13.3a-screenshot-portal-and-selection.md) · [T-13.3b](../../tasks/093-t-13.3b-screenshot-save-copy-and-gate.md) · [T-13.4a](../../tasks/094-t-13.4a-screencast-portal-and-picker.md) · [T-13.4b](../../tasks/095-t-13.4b-screencast-stream-and-fallback.md) · [T-13.5a](../../tasks/096-t-13.5a-clipboard-round-trips.md) · [T-13.5b](../../tasks/097-t-13.5b-clipboard-history.md) · [T-13.6](../../tasks/098-t-13.6-polkit-authentication-agent.md) · [T-13.7](../../tasks/099-t-13.7-flatpak-validation-and-capture.md). Strict order and prerequisites live in [ROADMAP.md](../../ROADMAP.md).
...
| **Legacy detail** | [legacy/27-portal-backend.md](../../tasks/legacy/27-portal-backend.md) · [legacy/28-screenshot-recording-ui.md](../../tasks/legacy/28-screenshot-recording-ui.md) · [legacy/29-clipboard-auth-agent.md](../../tasks/legacy/29-clipboard-auth-agent.md) · [07-system-integration.md](../07-system-integration.md) |
