...
> **Track, not a single slice.** This file is the design reference. It is executed as 3 one-session tasks: [T-06.1](../../tasks/029-t-06.1-app-switcher-state-machine.md) · [T-06.2a](../../tasks/030-t-06.2a-switcher-overlay-and-previews.md) · [T-06.2b](../../tasks/031-t-06.2b-switcher-commit-and-cycling.md). Strict order and prerequisites live in [ROADMAP.md](../../ROADMAP.md).
...
| **Depends on** | T-05 |
| **Blocks** | T-17 |
| **Legacy detail** | [legacy/12-app-switcher.md](../../tasks/legacy/12-app-switcher.md) · [04-shell.md](../04-shell.md) · [legacy/11-mission-control-workspace-ux.md](../../tasks/legacy/11-mission-control-workspace-ux.md) (recency) |
