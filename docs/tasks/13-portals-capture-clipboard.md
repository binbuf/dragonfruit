...
> **Track, not a single slice.** This file is the design reference. It is executed as 7 one-session units: [T-13.1](units/058-t-13.1-portal-backend-skeleton-and-session-service.md) · [T-13.2](units/059-t-13.2-filechooser-portal.md) · [T-13.3](units/060-t-13.3-screenshot-portal-and-capture-ui.md) · [T-13.4](units/061-t-13.4-screencast-portal-and-source-picker.md) · [T-13.5](units/062-t-13.5-clipboard-round-trips.md) · [T-13.6](units/063-t-13.6-polkit-authentication-agent.md) · [T-13.7](units/064-t-13.7-flatpak-validation-and-capture.md). Strict order and prerequisites live in [ROADMAP.md](../ROADMAP.md).
