...
> **Track, not a single slice.** This file is the design reference. It is executed as 11 one-session units: [T-16.1](units/088-t-16.1-per-output-chrome-sizing-and-placement.md) · [T-16.2](units/089-t-16.2-hotplug-under-load-and-lockstep.md) · [T-16.3](units/090-t-16.3-fractional-scaling.md) · [T-16.4](units/091-t-16.4-suspend-resume-soak.md) · [T-16.5](units/092-t-16.5-graphics-driver-matrix.md) · [T-16.6](units/093-t-16.6-accessibility-audit.md) · [T-16.7](units/094-t-16.7-localization-and-i18n.md) · [T-16.8](units/095-t-16.8-crash-recovery-kill-matrix.md) · [T-16.9](units/096-t-16.9-fedora-packaging-and-ci.md) · [T-16.10](units/097-t-16.10-debian-packaging-and-ci.md) · [T-16.11](units/098-t-16.11-packaged-build-performance-re-measure.md). Strict order and prerequisites live in [ROADMAP.md](../ROADMAP.md).
