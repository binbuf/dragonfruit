...
> **Track, not a single slice.** This file is the design reference. It is executed as 15 one-session units: [T-16.1a](units/145-t-16.1a-per-output-chrome-sizing.md) · [T-16.1b](units/146-t-16.1b-per-output-window-placement.md) · [T-16.2](units/147-t-16.2-hotplug-under-load-and-lockstep.md) · [T-16.3a](units/148-t-16.3a-integer-scaled-xwayland.md) · [T-16.3b](units/149-t-16.3b-viewport-downscale-and-chrome.md) · [T-16.4](units/150-t-16.4-suspend-resume-soak.md) · [T-16.5](units/151-t-16.5-graphics-driver-matrix.md) · [T-16.6a](units/152-t-16.6a-atspi-and-keyboard-audit.md) · [T-16.6b](units/153-t-16.6b-magnifier-and-reduced-motion-sweep.md) · [T-16.7](units/154-t-16.7-localization-and-i18n.md) · [T-16.8a](units/155-t-16.8a-crash-kill-matrix.md) · [T-16.8b](units/156-t-16.8b-compositor-death-and-restart-policy.md) · [T-16.9](units/157-t-16.9-fedora-packaging-and-ci.md) · [T-16.10](units/158-t-16.10-debian-packaging-and-ci.md) · [T-16.11](units/159-t-16.11-packaged-build-performance-re-measure.md). Strict order and prerequisites live in [ROADMAP.md](../ROADMAP.md).
...
| **Blocks** | T-17 |
| **Legacy detail** | [legacy/31-polish-hardening.md](legacy/31-polish-hardening.md) · [legacy/32-packaging-distribution.md](legacy/32-packaging-distribution.md) · [legacy/14-hot-corners-desktop-background.md](legacy/14-hot-corners-desktop-background.md) · [testing-ladder.md](../testing-ladder.md) |
