...
> **Track, not a single slice.** This file is the design reference. It is executed as 7 one-session units: [T-10.1](units/042-t-10.1-files-core-streaming-listing-and-model.md) · [T-10.2](units/043-t-10.2-files-core-operations-and-optimistic-semantics.md) · [T-10.3](units/044-t-10.3-files-core-trash-and-folder-watcher.md) · [T-10.4](units/045-t-10.4-files-ui-shell-and-views.md) · [T-10.5](units/046-t-10.5-files-performance-budgets.md) · [T-10.6](units/047-t-10.6-dock-integration-one-trash-source.md) · [T-10.7](units/048-t-10.7-files-capture-and-acceptance-walkthrough.md). Strict order and prerequisites live in [ROADMAP.md](../ROADMAP.md).
