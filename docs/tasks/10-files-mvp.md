...
> **Track, not a single slice.** This file is the design reference. It is executed as 14 one-session units: [T-10.1a](units/059-t-10.1a-files-core-streaming-listing.md) · [T-10.1b](units/060-t-10.1b-files-core-sorting-and-platform.md) · [T-10.2a](units/061-t-10.2a-files-core-operations.md) · [T-10.2b](units/062-t-10.2b-optimistic-semantics.md) · [T-10.3a](units/063-t-10.3a-files-core-trash.md) · [T-10.3b](units/064-t-10.3b-files-core-folder-watcher.md) · [T-10.4a](units/065-t-10.4a-files-window-toolbar-sidebar.md) · [T-10.4b](units/066-t-10.4b-files-list-and-icon-views.md) · [T-10.4c](units/067-t-10.4c-files-context-menus-multiselect.md) · [T-10.5](units/068-t-10.5-files-performance-budgets.md) · [T-10.6a](units/069-t-10.6a-dock-trash-source.md) · [T-10.6b](units/070-t-10.6b-dock-drop-to-trash-and-empty.md) · [T-10.6c](units/071-t-10.6c-files-navigation-and-desktop-identity.md) · [T-10.7](units/072-t-10.7-files-capture-and-acceptance-walkthrough.md). Strict order and prerequisites live in [ROADMAP.md](../ROADMAP.md).
...
| **Legacy detail** | [legacy/17-files-core.md](legacy/17-files-core.md) · [legacy/18-files-app.md](legacy/18-files-app.md) · [09-files.md](../design/09-files.md) |
